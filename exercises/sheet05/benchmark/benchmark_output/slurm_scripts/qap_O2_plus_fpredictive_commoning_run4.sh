...
#SBATCH --job-name=qap_O2_plus_fpredictive_commoning_run4
#SBATCH --output=/gpfs/gpfs1/scratch/cb761223/exercises/sheet05/benchmark/benchmark_output/slurm_logs/qap_O2_plus_fpredictive_commoning_run4.log
#SBATCH --error=/gpfs/gpfs1/scratch/cb761223/exercises/sheet05/benchmark/benchmark_output/slurm_logs/qap_O2_plus_fpredictive_commoning_run4.log
#SBATCH --ntasks=1
#SBATCH --nodes=1
...
echo "Log File: /gpfs/gpfs1/scratch/cb761223/exercises/sheet05/benchmark/benchmark_output/slurm_logs/qap_O2_plus_fpredictive_commoning_run4.log"
...
if grep -q "real" "/gpfs/gpfs1/scratch/cb761223/exercises/sheet05/benchmark/benchmark_output/slurm_logs/qap_O2_plus_fpredictive_commoning_run4.log"; then
