...
#SBATCH --output=/gpfs/gpfs1/scratch/cb761223/exercises/sheet04/perf/slurm_logs/npb_bt_c_baseline.log # Log path in logs_dir
#SBATCH --ntasks=1
...
echo "Output log: /gpfs/gpfs1/scratch/cb761223/exercises/sheet04/perf/slurm_logs/npb_bt_c_baseline.log"
...
time (/gpfs/gpfs1/scratch/cb761223/perf-oriented-dev/larger_samples/npb_bt/build/npb_bt_c)
