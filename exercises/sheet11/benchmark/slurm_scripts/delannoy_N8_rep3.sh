#!/bin/bash
#SBATCH --job-name=delannoy_N8_rep3
#SBATCH --partition=lva
#SBATCH --cpus-per-task=4
#SBATCH --mem=16G
#SBATCH --time=00:60:00
#SBATCH --output=/scratch/cb761223/sheet11/benchmark/slurm_logs/delannoy_N8_rep3.out
#SBATCH --error=/scratch/cb761223/sheet11/benchmark/slurm_logs/delannoy_N8_rep3.out
