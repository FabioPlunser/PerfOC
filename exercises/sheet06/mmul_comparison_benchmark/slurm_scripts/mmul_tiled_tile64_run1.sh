...
#SBATCH --job-name=mmul_tiled_tile64_run1
#SBATCH --output=/gpfs/gpfs1/scratch/cb761223/exercises/sheet06/mmul_comparison_benchmark/slurm_logs/mmul_tiled_tile64_run1.log
#SBATCH --error=/gpfs/gpfs1/scratch/cb761223/exercises/sheet06/mmul_comparison_benchmark/slurm_logs/mmul_tiled_tile64_run1.log # Combine stdout/stderr
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo "Log File: /gpfs/gpfs1/scratch/cb761223/exercises/sheet06/mmul_comparison_benchmark/slurm_logs/mmul_tiled_tile64_run1.log"
