...
#SBATCH --output=/gpfs/gpfs1/scratch/cb761223/exercises/sheet04/perf/slurm_logs/ssca2_s17_baseline.log # Log path in logs_dir
#SBATCH --ntasks=1
...
echo "Output log: /gpfs/gpfs1/scratch/cb761223/exercises/sheet04/perf/slurm_logs/ssca2_s17_baseline.log"
...
time (/gpfs/gpfs1/scratch/cb761223/perf-oriented-dev/larger_samples/ssca2/build/ssca2 17)
