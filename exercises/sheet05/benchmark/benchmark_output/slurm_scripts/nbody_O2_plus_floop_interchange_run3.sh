...
#SBATCH --job-name=nbody_O2_plus_floop_interchange_run3
#SBATCH --output=/gpfs/gpfs1/scratch/cb761223/exercises/sheet05/benchmark/benchmark_output/slurm_logs/nbody_O2_plus_floop_interchange_run3.log
#SBATCH --error=/gpfs/gpfs1/scratch/cb761223/exercises/sheet05/benchmark/benchmark_output/slurm_logs/nbody_O2_plus_floop_interchange_run3.log
#SBATCH --ntasks=1
#SBATCH --nodes=1
...
echo "Log File: /gpfs/gpfs1/scratch/cb761223/exercises/sheet05/benchmark/benchmark_output/slurm_logs/nbody_O2_plus_floop_interchange_run3.log"
...
if grep -q "real" "/gpfs/gpfs1/scratch/cb761223/exercises/sheet05/benchmark/benchmark_output/slurm_logs/nbody_O2_plus_floop_interchange_run3.log"; then
